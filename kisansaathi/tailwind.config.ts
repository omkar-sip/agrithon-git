...
export default {
  ...
  theme: {
    extend: {
      // ── Color Palette — "Clean Agricultural Pro" ──────────────────────────
      colors: {
        // Primary brand — deep, professional forest green
        forest: {
          50:  '#F0FAF4',
          100: '#DCFCE7',
          200: '#BBF7D0',
          ...
          700: '#15803D',
          800: '#166534',
          900: '#1B4332',  // primary brand (Bloomberg-dark)
          950: '#052E16',
        },
        // Accent — muted professional gold (not neon yellow)
        gold: {
          50:  '#FFFBEB',
          100: '#FEF3C7',
          200: '#FDE68A',
        ...
        // Status (muted, professional — not traffic-light cartoon)
      ...
      boxShadow: {
        ...
        'fab':     '0 4px 20px rgba(27,67,50,0.35)',
